    ...
    def parse(self, text: str) -> ParseResult:
        ...
        return ParseResult(
            ...
            specification=ProductSpecification(
                ...
                specification_text=rule_result.specification.specification_text,
                extraction_source="llm",
                status="NEED_MORE_EVIDENCE" if suggestion.confidence < self.confidence_threshold else "RESOLVED",
                evidence=rule_result.specification.evidence,
            ...
            decision_status="NEED_MORE_EVIDENCE" if suggestion.confidence < self.confidence_threshold else "RESOLVED",
            llm_fallback_attempted=True,
