...
def main() -> None:
    ...
    parser.add_argument(
        "--annotations",
        type=Path,
        help="optional human annotation JSONL overlay; HUMAN_VERIFIED is never generated by the runner",
    )
    ...
    report = evaluate_dataset(args.dataset, set(args.sample_id) if args.sample_id else None, annotations)
